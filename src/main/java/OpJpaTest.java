...
public class OpJpaTest {
	...
	private static Logger log = LoggerFactory.getLogger(OpJpaTest.class);
...
//	private final static String DEBUGFILE = null;
	...
	public static class HelloJob implements Job {
		...
		private static org.slf4j.Logger _log = LoggerFactory.getLogger(HelloJob.class);
	    ...
	    public void execute(JobExecutionContext context) throws JobExecutionException {
	        ...
	        readCasesFromDatabase(em);
	        em.close();
	    }

		public void readCasesFromDatabase(EntityManager em) {
		...
		public void persistCasesForDate(Date date, EntityManager em) throws Exception {
...
//	        QueueUtility queue = new QueueUtility(compressSections);  // true is compress references within individual titles
			...
			// There might be entries for this date already, 
			// so, instead of assuming there are not, do a read and 
			// merge any entries that need to be merged.
			...
			tx.begin();
			opDatabase.mergeAndPersistCases(courtCases);
			tx.commit();
