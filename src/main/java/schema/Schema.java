...
• javax.persistence.schema-generation.database.action ◦ specifies the action to be taken by the persistence provider with regard to the database artifacts
  ◦ Valid values for this property: none, create, drop-and-create, drop

• javax.persistence.schema-generation.scripts.action ◦ specifies which scripts are to be generated by the persistence provider
  ◦ Valid values for this property: none, create, drop-and-create, drop
...
• javax.persistence.database-product-name ◦ specified if scripts are to be generated by the persistence provider and a connection to the target database is not supplied.
...
javax.persistence.schema-generation.database.action 
	...
	drop Defines whether the persistence provider shall create the database, first drop and then recreate it, only drop it or do nothing at all.
