...
create table partyattorneypair (id integer not null auto_increment, attorney varchar(3071), party varchar(1023), slipproperties_slipopinion_id integer, primary key (id)) ENGINE=InnoDB;
create table role (id bigint not null auto_increment, role varchar(255) not null, primary key (id)) ENGINE=InnoDB;
create table slipproperties (author varchar(63), casecaption varchar(255), casecitation varchar(255), casetype varchar(15), completiondate datetime, county varchar(127), court varchar(15), date datetime, disposition varchar(127), dispositiondescription varchar(255), division varchar(31), fileextension varchar(7), filename varchar(31), filingdate datetime, participants varchar(255), publicationstatus varchar(31), trialcourtcase varchar(63), trialcourtcasenumber varchar(63), trialcourtjudge varchar(127), trialcourtjudgmentdate datetime, trialcourtname varchar(127), slipopinion_id integer not null, primary key (slipopinion_id)) ENGINE=InnoDB;
