...
create table slipproperties (court varchar(15), disposition varchar(31), fileextension varchar(7), filename varchar(31), summary varchar(4007), slipopinion_opinionkey bigint not null, primary key (slipopinion_opinionkey)) ENGINE=InnoDB;
